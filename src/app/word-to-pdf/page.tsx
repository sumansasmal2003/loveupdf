...
import { FileText, File as FileIcon, Loader2, X, Sparkles, Download } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center flex-1 p-6 sm:p-12 md:p-20 max-w-4xl mx-auto w-full">
      <header className="text-center mb-10 w-full">
        <h1 className="text-3xl sm:text-4xl font-medium text-[#e3e3e3] mb-4">Word to PDF</h1>
        <p className="text-[#c4c7c5]">Convert your DOCX files to secure, uneditable PDF documents.</p>
      </header>
      ...
      {!file ? (
        <FileUploader
          ...
          acceptText="Only .docx files are supported"
        />
      ) : (
            ...
            >
              ...
              <div className="flex items-center justify-between pb-6 border-b border-white/5 mb-6 z-10 w-full">
                <div className="flex items-center gap-4 overflow-hidden flex-1 min-w-0">
                  ...
                  <div className="flex flex-col overflow-hidden flex-1 min-w-0">
                    ...
                    <span className="text-sm text-[#8e918f]">{isProcessing ? "Converting securely..." : "Ready for conversion"}</span>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-[#8ab4f8]/10 border border-[#8ab4f8]/20 rounded-xl mb-6">
                ...
                <p className="text-sm text-[#c4c7c5]">
                  <strong className="text-[#8ab4f8] font-medium">Lossless & Private:</strong> Processed securely on your custom backend. Fonts, tables, and images are perfectly preserved.
                </p>
              </div>
